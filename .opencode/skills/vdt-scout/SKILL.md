...
**Typically precedes:** `/vdt:debug` (debug after scouting), `/vdt:fix` (fix after locating code), `/vdt:code-review` (scout edge cases before review)
**Related:** `/vdt:debug` (investigate after scouting), `/vdt:brainstorm` (explore after scouting)
