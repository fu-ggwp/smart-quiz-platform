        ...
        <section className="w-full max-w-md text-center">
          ...
          <div className="flex justify-center gap-3">
            ...
            <button
              ...
              className="rounded-lg border border-neutral-200 px-5 py-2.5 text-sm hover:bg-neutral-50"
            >
              Join Another
            </button>
          </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              maxLength={6}
              className="rounded-lg border border-neutral-200 px-4 py-3 font-mono text-lg tracking-widest outline-none focus:border-neutral-400 uppercase"
            />
          ...
          <button
            ...
            className="rounded-lg bg-black py-3 text-sm font-medium text-white hover:bg-neutral-800 disabled:opacity-50 disabled:cursor-not-allowed"
          >
